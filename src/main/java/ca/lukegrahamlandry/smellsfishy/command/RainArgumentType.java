...
public class RainArgumentType extends ResourceLocationArgument {
    private static final DynamicCommandExceptionType INVALID = new DynamicCommandExceptionType((p_106991_) -> {
        return new TranslationTextComponent("error.smellsfishy.invalid_event", p_106991_);
    });

    public static ResourceLocation get(CommandContext<CommandSource> p_107002_, String p_107003_) throws CommandSyntaxException {
